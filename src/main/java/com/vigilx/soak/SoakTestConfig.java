...
public record SoakTestConfig(
        ...
        boolean alertRequired, String alertPath, boolean logoutEnabled, boolean passScreenshot,
    ...
    public static SoakTestConfig load() {
        return new SoakTestConfig(
                ...
                ConfigReader.getBoolean("soak.alert.required"), ConfigReader.get("soak.alert.path"),
